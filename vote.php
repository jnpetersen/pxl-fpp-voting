...
<?php
$path = "/home/fpp/media/plugins/pxl-fpp-voting";
...
function startService() {
    ...
    $privateKey = ReadSettingFromFile('privateKey', 'pxl-voting');
    WriteSettingToFile("publicApiKey", "false", "pxl-voting");
...
<script>
    ...
    function getAllSettings(callback) {
        var url = 'api/configfile/plugin.pxl-voting';
        $.ajax({
            type: 'GET',
            url: url,
